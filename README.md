...
Interactions: anchor navigation, a keyboard-accessible mobile menu, email and telephone links, intersection-based section reveals, gentle scroll parallax and desktop stacking service cards. Native scrolling is preserved. Reduced-motion preferences disable animated motion and stacking. Contact links open the visitor's email or telephone application; there is no simulated form submission or booking backend.
